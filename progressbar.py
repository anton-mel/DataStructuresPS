...
def progressbar(itr, *,
    ...
    `prefix`, `suffix`, and `completion` are the messages that should be displayed on the lable side
        of the progress bar, the value side of the progress bar, and in the console when the task
        is complete.
